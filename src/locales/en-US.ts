export default {
  ...
  marketplace: {
    ...
    globalOnly: 'Global installs write to the selected CLI global config file.',
    projectInstallHint: 'Project installs write to the CLI project-level config in the project root you specify.',
    projectScopeUnavailable: 'The selected CLI does not support project-scoped MCP installs.',
    projectPath: 'Project Path',
    projectPathPlaceholder: 'Enter the project root path, for example /path/to/project',
